...
#         conn.read_parquet(f"{init_char_pq_path}")
...
#         pa.Table.from_pylist([example.model_dump()], schema=schema)
#         sql_cmd = "INSERT INTO char_db SELECT * FROM tbl RETURNING *"
#         print(sql_cmd)
#         df = conn.sql(sql_cmd)
#         print(df)
...
#     print(model)
#     pa.Table.from_pylist([model], schema=Character.arrow_schema())
#     sql_cmd = "INSERT INTO char_db SELECT * FROM tbl RETURNING *"
#     df = conn.sql(sql_cmd)
#     print(df)
#     return char
